...
- (instancetype)initWithURL:(NSURL*)url frameUpdater:(FLTFrameUpdater*)frameUpdater network:(BOOL)network;
- (void)play;
- (void)pause;
...
- (instancetype)initWithAsset:(NSString*)asset frameUpdater:(FLTFrameUpdater*)frameUpdater {
  ...
  return [self initWithURL:[NSURL fileURLWithPath:path] frameUpdater:frameUpdater network:NO];
}
...
- (instancetype)initWithURL:(NSURL*)url frameUpdater:(FLTFrameUpdater*)frameUpdater network:(BOOL)network {
    ...
    AVPlayerItem* item;
    if (network) {
        AVURLAsset *asset = [[APHLSCache instance] checkIfHasOfflineAsset:url];
        if (asset) {
